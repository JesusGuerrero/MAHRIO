...
var jasmine = require('jasmine-bail-fast');
...
describe('Mahrio dashboard', function () {
    ...
    var takeScreenCap =  function () {
        ...
        //var fullImageFilenameAndPath = browser.params.baseTestFolderName + path.sep + suiteName + path.sep +
        // browser.params.browserName + path.sep + paddedCounter + "_" + message + "_" + width + "x" + height + ".png";
